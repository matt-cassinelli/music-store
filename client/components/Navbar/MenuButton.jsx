...
export default function MenuButton() {
  ...
  return (
    <button type='button' className='hidden md:visible h-7' onClick={() => dispatch(toggleMenu())}>
      <svg className='fill-primary stroke-primary' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92.8 92.8">
